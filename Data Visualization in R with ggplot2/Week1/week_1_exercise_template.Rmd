...
fig115$Gender <- recode(fig115$female, '1'="Female", '0'="Male")

ggplot(fig115, aes(x=dwnom1,y=all_pass, color=Gender))+ 
  geom_point() + 
...
fig115$majority=recode(fig115$majority,'0'="Minority",'1'="Majority")
